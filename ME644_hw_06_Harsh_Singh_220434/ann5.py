...
# Define the ANN class with improved initialization
class ANN:
    def __init__(self, input_size, hidden_size1, hidden_size2, output_size, learning_rate=0.01):
        # Xavier initialization for weights to improve convergence
        self.W1 = np.random.randn(input_size, hidden_size1) * np.sqrt(1 / input_size)
        self.b1 = np.random.randn(1, hidden_size1) * 0.01  # Random small values for bias
